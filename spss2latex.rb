...
if ARGV.length < 1
  abort "Usage: spss2latex.rb <exported-table.txt> [<more-exported-tables.txt> ...]"
end

ARGV.each_with_index do |file, filei|
  t = File.read(file)
  ...
  def get_column_span(column_index, column_width)
  ...
  def get_row_span(column_index, row_index)
